# Code of Conduct Proposal/Draft 2

!!! note "Source"
    Mirrored from [Code of Conduct Proposal/Draft 2](https://dallasmakerspace.org/wiki/Code_of_Conduct_Proposal/Draft_2) on the Dallas Makerspace wiki (CC BY-SA 3.0).
...
These rules and policies are subject to change. Changes will become effective immediately upon successful vote of adoption by the [Board of Directors](../dms-official/board-of-directors.md). The DMS Secretary shall maintain the documented version of the official DMS Rules and Bylaws. A summarized version of these rules will be posted in the space, with a link to the full rules.
...
1.  Tools/resources must stay on the premises so that other members may use them. Removing tools/resources from the space without authorization from an Officer or member of the Board of Directors is theft.
    1.  An [Officer](../officers/officers.md) or [Director](../dms-official/board-of-directors.md) may authorize the temporary removal of a tool/resource for purposes relevant to organizational business
    2.  The Chair or Vice-Chair of the Committee responsible for the tool/resource may authorize its removal for maintenance purposes but shall notify the [Board of Directors](../dms-official/board-of-directors.md) of its removal, the specific purpose of its removal, the party/parties in custody, and its expected date of return.
...
2.  The [Board of Directors](../dms-official/board-of-directors.md) may decide through informal consensus to either hold a special meeting regarding this matter or consider it at the next meeting in its cycle.
3.  The [Board of Directors](../dms-official/board-of-directors.md) is not required to act in accordance to the grievance or complainant's "Recommended Solution" part and may devise its own remediation.
...
6.  Any disciplinary action for which one or more of the [Board of Directors](../dms-official/board-of-directors.md) or officers of the corporation (acting in their role as an officer) are involved require that a written record of the action, reason(s) for the action, and acknowledgement of the accused be sent to the Board of Directors for keeping.

### Suspension

1.  The [Board of Directors](../dms-official/board-of-directors.md) may expel anyone who violates our rules via resolution from the premises, online systems, or at sponsored events.
2.  [Officers](../officers/officers.md) of the Corporation may temporarily suspend a member from the Dallas Makerspace premises, online systems, or at sponsored events provided the following conditions are met:
    ...
    3.  The member being suspended, other [Officers](../officers/officers.md), and the [Board of Directors](../dms-official/board-of-directors.md) are informed in writing as soon as possible
    4.  Upon reviewing reasonably complete details of the incident and believing a temporary suspension to be in error, a [Board](../dms-official/board-of-directors.md) member may revoke a temporary expulsion; the [Board of Directors](../dms-official/board-of-directors.md) may also opt to rescind a temporary suspension by resolution
    5.  The power to temporarily suspend may not be delegated - only the named [Officer](../officers/officers.md) may perform the temporary expulsion.
...
|----|----|----|
| Monthly Membership | \$60/mo | Eligible for voting rights after 90 days, see [Voting Rights](../dms-official/rules-and-policies.md#voting-rights). |
| Student/Retired/Veteran/Disabled | \$40/mo | This rate is for members who qualify under one of these three categories: in school, retired, veteran, or disabled *(with Social Security Benefit Verification Letter)*. Please contact accounts@dallasmakerspace.org to find out if you qualify. Eligible for voting rights after 90 days, see [Voting Rights](../dms-official/rules-and-policies.md#voting-rights). |
...
| Yearly Membership | \$648/year | This rate is 10% off the monthly rate of \$60. Eligible for voting rights after 90 days, see [Voting Rights](../dms-official/rules-and-policies.md#voting-rights). |
...
3.  Scheduled classes/events should uphold our [Mission Statement](../dallas-makerspace/mission-statement.md)
...
2.  For purchases over \$200, the request must include a description of how this spending furthers the organization's Tax Exempt purpose (see [Mission Statement](../dallas-makerspace/mission-statement.md).)
...
1.  Committee purchasing is controlled by the [Financial Policy Manual, Board-set allocation and authorization limits](../dms-official/financial-policy-manual.md#board-set-allocation-and-authorization-limits).
...
A list of active committees can be found in the [Active Committees](https://dallasmakerspace.org/wiki/Category:Active_Committees) category.

### Inactive Committees

A list of inactive committees can be found in the [Inactive Committees](https://dallasmakerspace.org/wiki/Category:Inactive_Committees) category.

### Proposed Committees

A list of proposed committees can be found in the [Proposed Committees](https://dallasmakerspace.org/wiki/Category:Proposed_Committees) category.

## Organizational Roles and Responsibilities

### Finances

The organization's finances are controlled by the [Financial Policy Manual.](../dms-official/financial-policy-manual.md)

### Treasurer and Financial Group

The duties of the Treasurer and Financial Group are defined in the [Financial Policy Manual, Dallas Makerspace Treasurer's Office](../dms-official/financial-policy-manual.md#dallas-makerspace-treasurer-e2-80-99s-office).

### Other Officers

Other Dallas Makerspace Officers are defined on their respective pages in the [Officers](../officers/officers.md) section.
...
3.  Certain items are not accepted. The Logistics committee or its successor regulates the list of unacceptable items. The complete list can be found on the [Logistics Committee page](https://dallasmakerspace.org/wiki/Logistics_Committee).
...
1.  [↑](#cite_ref-1) This includes taking out the trash, wiping down tables, vacuuming/sweeping floors, returning tools to the proper place, etc.
2.  [↑](#cite_ref-2) You will not be asked to replace/repair equipment due to honest mistakes, we just want to know **why** something broke so we can prevent it in the future.
3.  [↑](#cite_ref-3) The previous [firearms policy](https://dallasmakerspace.org/wiki/File:Dallas_Makerspace_Policy_on_Working_on_Firearms-20180618.pdf) has been replaced as of the 2019-11-17 BoD meeting
4.  [↑](#cite_ref-4) Primary contact is via admin@dallasmakerspace.org
5.  [↑](#cite_ref-5) Per BoD 2019-08-25 7.1, cash is no longer accepted for payment of dues
6.  [↑](#cite_ref-6) Per our [Bylaws](../dms-official/bylaws.md) we have two classes of membership: *Supporting Members* and *Regular Members*. The only difference between these two classes is that *Regular Members* have been granted voting rights within the organization.
7.  [↑](#cite_ref-7) This resource is no longer available due to maintenance problems and inaccuracies in reporting.
8.  [↑](#cite_ref-8) Use the "Add Event" link on the [Events](https://calendar.dallasmakerspace.org) page.
9.  [↑](#cite_ref-9) This rule was suspended [2019-07-10](../board-of-directors-meetings/board-of-directors-meeting-20190710-special-meeting.md) and will remain suspended until the Board takes action to restore it
