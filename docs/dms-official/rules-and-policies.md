...
!!! note "Source"
    Mirrored from [Rules and Policies](https://dallasmakerspace.org/wiki/Rules_and_Policies) on the Dallas Makerspace wiki (CC BY-SA 3.0).
...
3.  The [Board of Directors](board-of-directors.md) may expel anyone who violates the Code of Conduct via resolution from the premises, online systems, or at sponsored events.
4.  [Officers](../officers/officers.md) of the Corporation may temporarily suspend a member from the Dallas Makerspace premises, online systems, or at sponsored events provided the following conditions are met:
    ...
    3.  The member being suspended, other [Officers](../officers/officers.md), and the [Board of Directors](board-of-directors.md) are informed in writing as soon as possible
    4.  Upon reviewing reasonably complete details of the incident and believing a temporary suspension to be in error, a [Board](board-of-directors.md) member may revoke a temporary expulsion; the [Board of Directors](board-of-directors.md) may also opt to rescind a temporary suspension by resolution
...
5.  Don't merely respect each other; be excellent to each other.
    ...
    5.  Tools/resources must stay on the premises so that other members may use them. Removing tools/resources from the space without authorization from an Officer or member of the Board of Directors is theft.
        1.  An [Officer](../officers/officers.md) or [Director](board-of-directors.md) may authorize the temporary removal of a tool/resource for purposes relevant to organizational business
        2.  The Chair or Vice-Chair of the Committee responsible for the tool/resource may authorize its removal for maintenance purposes but shall notify the [Board of Directors](board-of-directors.md) of its removal, the specific purpose of its removal, the party/parties in custody, and its expected date of return.
...
14. It is the responsibility of each member to help enforce the Code of Conduct. If someone is violating the Code of Conduct politely explain to them why their behavior is not acceptable. Egregious violations should be reported to a [Director](board-of-directors.md) or the [Officers](../officers/officers.md).
...
2.  The [Board of Directors](board-of-directors.md) may decide through informal consensus to either hold a special meeting regarding this matter or consider it at the next meeting in its cycle.
3.  The [Board of Directors](board-of-directors.md) is not required to act in accordance to the grievance or complainant's "Recommended Solution" part and may devise its own remediation.
...
|----|----|----|
| Monthly Membership | \$60/mo | Eligible for voting rights after 90 days, see [Voting Rights](rules-and-policies.md#voting-rights). |
| Student/Retired/Veteran/Disabled | \$40/mo | This rate is for members who qualify under one of these three categories: in school, retired, veteran, or disabled *(with Social Security Benefit Verification Letter)*. Please contact accounts@dallasmakerspace.org to find out if you qualify. Eligible for voting rights after 90 days, see [Voting Rights](rules-and-policies.md#voting-rights). |
...
| Yearly Membership | \$648/year | This rate is 10% off the monthly rate of \$60. Eligible for voting rights after 90 days, see [Voting Rights](rules-and-policies.md#voting-rights). |
...
1.  Committee purchasing is controlled by the [Financial Policy Manual, Board-set allocation and authorization limits](financial-policy-manual.md#board-set-allocation-and-authorization-limits).
...
The organization's finances are controlled by the [Financial Policy Manual.](financial-policy-manual.md)

## Organizational Roles and Responsibilities

### Treasurer and Financial Group

The duties of the Treasurer and Financial Group are defined in the [Financial Policy Manual, Dallas Makerspace Treasurer's Office](financial-policy-manual.md#dallas-makerspace-treasurer-e2-80-99s-office).
...
1.  [↑](#cite_ref-1) You will not be asked to replace/repair equipment due to honest mistakes, we just want to know **why** something broke so we can prevent it in the future.
2.  [↑](#cite_ref-2) This includes taking out the trash, wiping down tables, vacuuming/sweeping floors, returning tools to the proper place, etc.
3.  [↑](#cite_ref-3) Primary contact is via admin@dallasmakerspace.org
4.  [↑](#cite_ref-4) The previous [firearms policy](https://dallasmakerspace.org/wiki/File:Dallas_Makerspace_Policy_on_Working_on_Firearms-20180618.pdf) has been replaced as of the 2019-11-17 BoD meeting
5.  [↑](#cite_ref-5) Per BoD 2019-08-25 7.1, cash is no longer accepted for payment of dues
6.  [↑](#cite_ref-6) Per our [Bylaws](bylaws.md) we have two classes of membership: *Supporting Members* and *Regular Members*. The only difference between these two classes is that *Regular Members* have been granted voting rights within the organization.
